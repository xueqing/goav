...
func (ctxt *AvCodecContext) AvcodecParametersFromContext(cp *AvCodecParameters) int {
...
func (ctxt *AvCodecContext) AvcodecParametersToContext(cp *AvCodecParameters) int {
...
func (ctxt *AvCodecContext) AvcodecDefaultGetBuffer2(f *AvFrame, l int) int {
...
func (ctxt *AvCodecContext) SetTimebase(num1 int, den1 int) {
	ctxt.time_base.num = C.int(num1)
	ctxt.time_base.den = C.int(den1)
}

// SetEncodeParams2 ...
func (ctxt *AvCodecContext) SetEncodeParams2(width int, height int, pxlFmt AvPixelFormat, hasBframes bool, gopSize int) {
...
// SetEncodeParams ...
func (ctxt *AvCodecContext) SetEncodeParams(width int, height int, pxlFmt AvPixelFormat) {
...
func (ctxt *AvCodecContext) AvcodecSendPacket(packet *AvPacket) int {
...
func (ctxt *AvCodecContext) AvcodecReceiveFrame(frame *AvFrame) int {
